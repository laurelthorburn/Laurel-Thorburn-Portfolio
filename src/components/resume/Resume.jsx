        ...
        <div className="resume">
            ...
            <div className="resume-right">
                ...
                <div className="resumeContact">
                    ...
                    <span><a href="https://drive.google.com/file/d/1Yo_9a2iOZ0rsJ-veGJPgxC8EfAvDOjDc/view?usp=sharing" target="_blank" rel="noreferrer"><img src={MiniDownload} alt="download icon" className='resumeMini'  /></a> Open Resume (PDF)</span>
                    ...
                    <span><a href="tel:7207369393" target="_blank" rel="noreferrer"><img src={MiniPhone} alt="phone icon" className='resumeMini'  /></a> +1 720-736-9393</span>
                    <span><a href="https://laurelthorburn.com" target="_blank" rel="noreferrer"><img src={MiniSite} alt="website icon" className='resumeMini'  /></a> laurelthorburn.com (coming soon)</span>
                    <span><a href="https://www.instagram.com/flaurel_designs/" target="_blank" rel="noreferrer"><img src={MiniInsta} alt="instagram icon" className='resumeMini'  /></a> @flaurel_designs</span>
                </div>
            </div>
            </div>
        </div>
